...
static constexpr int8_t cluster_recovery_start_cmd_type = 1;
static constexpr int8_t cluster_recovery_stop_cmd_type = 2;
...
using cluster_recovery_start_cmd = controller_command<
  int8_t, // Unused, always 0
  cluster_recovery_start_cmd_data,
  cluster_recovery_start_cmd_type,
  model::record_batch_type::cluster_recovery_cmd>;
using cluster_recovery_stop_cmd = controller_command<
  int8_t, // Unused, always 0
  cluster_recovery_stop_cmd_data,
  cluster_recovery_stop_cmd_type,
  model::record_batch_type::cluster_recovery_cmd>;
