...
TEST_F_CORO(archival_metadata_stm_gtest_fixture, test_sequence) {
    std::vector<cloud_storage::segment_meta> metas = {

      cloud_storage::segment_meta{
        .is_compacted = false,
        .size_bytes = 123,
        .base_offset = model::offset(372),
        .committed_offset = model::offset(372),
        .base_timestamp = model::timestamp(1698737002380),
        .max_timestamp = model::timestamp(1698737002380),
        .delta_offset = model::offset_delta(358),
        .ntp_revision = model::initial_revision_id(64),
        .archiver_term = model::term_id(100),
        .segment_term = model::term_id(94),
        .delta_offset_end = model::offset_delta(359),
        .sname_format = cloud_storage::segment_name_format(3),
        .metadata_size_hint = 0},
      cloud_storage::segment_meta{
        .is_compacted = false,
        .size_bytes = 123,
        .base_offset = model::offset(373),
        .committed_offset = model::offset(373),
        .base_timestamp = model::timestamp(1698737032776),
        .max_timestamp = model::timestamp(1698737032776),
        .delta_offset = model::offset_delta(359),
        .ntp_revision = model::initial_revision_id(64),
        .archiver_term = model::term_id(100),
        .segment_term = model::term_id(95),
        .delta_offset_end = model::offset_delta(360),
        .sname_format = cloud_storage::segment_name_format(3),
        .metadata_size_hint = 0},
      cloud_storage::segment_meta{
        .is_compacted = false,
        .size_bytes = 123,
        .base_offset = model::offset(374),
        .committed_offset = model::offset(374),
        .base_timestamp = model::timestamp(1698737107023),
        .max_timestamp = model::timestamp(1698737107023),
        .delta_offset = model::offset_delta(360),
        .ntp_revision = model::initial_revision_id(64),
        .archiver_term = model::term_id(100),
        .segment_term = model::term_id(96),
        .delta_offset_end = model::offset_delta(361),
        .sname_format = cloud_storage::segment_name_format(3),
        .metadata_size_hint = 0},
      cloud_storage::segment_meta{
        .is_compacted = false,
        .size_bytes = 123,
        .base_offset = model::offset(375),
        .committed_offset = model::offset(375),
        .base_timestamp = model::timestamp(1698737403266),
        .max_timestamp = model::timestamp(1698737403266),
        .delta_offset = model::offset_delta(361),
        .ntp_revision = model::initial_revision_id(64),
        .archiver_term = model::term_id(100),
        .segment_term = model::term_id(97),
        .delta_offset_end = model::offset_delta(362),
        .sname_format = cloud_storage::segment_name_format(3),
        .metadata_size_hint = 0},
    };
    co_await start();
    ss::abort_source never_abort;
    co_await with_leader(10s, [this](raft::raft_node_instance&) {
        return get_leader_stm().load_from_file();
    });
    co_await with_leader(10s, [&](raft::raft_node_instance&) {
        auto& m = get_leader_stm().manifest();
        vlog(fixture_logger.info, "Loaded from snapshot");
        for (const auto& s : m) {
            vlog(fixture_logger.info, "{}", s);
        }
    });
    auto res = co_await with_leader(
