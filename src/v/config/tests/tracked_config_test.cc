...
SEASTAR_THREAD_TEST_CASE(test_tracked_config_c) {
    BOOST_REQUIRE_MESSAGE(
      !config::shard_local_cfg().cluster_id().has_value(),
      config::shard_local_cfg().cluster_id()->c_str());
    tracked_local_config cfg;
