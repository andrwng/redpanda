...
class Admin:
    ...
    def transfer_leadership_to(self,
        ...
        this operations is NOP when current leader is the same as target. If
        user pass None for target this function will choose next replica for
        new leader.

        If leadership transfer was performed or if 'target_id' is already the
        leader, this function returns True.
        """
        def _get_details():
